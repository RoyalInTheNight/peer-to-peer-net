...
int8_t utils::_connect(int8_t fd, psockaddr __csock, socklen_t __csock_size) {
...
int8_t utils::_bind(int8_t fd, psockaddr __bsock, socklen_t __bsock_size) {
...
int8_t utils::_listen(int8_t fd, int64_t queue) {
...
int64_t utils::_recv(int8_t fd, pvoid buffer, size_t buffer_size, uint8_t flags) {
...
int64_t utils::_send(int8_t fd, pvoid buffer, size_t buffer_size, uint8_t flags) {
...
int64_t utils::_recvfrom(int8_t fd, pvoid buffer, size_t buffer_size, uint8_t flags, psockaddr __lsock, psocklen_t __lsock_size) {
...
int64_t utils::_sendto(int8_t fd, pvoid buffer, size_t buffer_size, uint8_t flags, psockaddr __ssock, socklen_t __ssock_size) {
...
int8_t utils::_accept(int8_t fd, psockaddr __lsock, psocklen_t __lsock_ssize) {
...
void peer::peerInit() {
    auto _initNodeConnection = ([&]() -> int8_t {
        ...
        int8_t fd = socket(AF_INET, SOCK_STREAM, IPPROTO_TCP);
...
void sigSignalServer::sigInit() {
    ...
    auto dbNode = ([&]() -> int8_t {
        ...
        while (1) {
            utils_local._listen(fd, 0x400);
            utils_local._accept(fd, (psockaddr)&lsock, &size_sock);
            ...
            utils_local._recv(fd, (win_netbuffer)nameBuffer, bytes32size, 0);
